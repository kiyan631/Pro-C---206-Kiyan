...
def leftBoard():
    ...
    for box in range(0,11):
        if(box == 0):
            ...
            boxLabel.place(x=xPos - 20, y=screen_height/2 - 88)
...
def rightBoard():
    ...
    for box in range(0,11):
        if(box == 10):
            ...
            boxLabel = Label(gameWindow, font=("Helvetica",55), width=1 ,height=1, relief='ridge', borderwidth=0, bg="white")
            boxLabel.place(x=xPos - 25, y=screen_height/2 - 100)
            rightBoxes.append(boxLabel)
            xPos +=50
...
def finishingBox():
    ...
    finishingBox.place(x=screen_width/2 - 90, y=screen_height/2 -160)
